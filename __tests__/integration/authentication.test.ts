...
//     const response = await request(app).get('/login').auth('test@hotmail.com', 'wrongPassword', { type: 'basic' })
...
//     const response = await request(app).get('/login').auth('wrong@hotmail.com', 'test', { type: 'basic' })
...
//     const response = await request(app).get('/login').auth('test@hotmail.com', 'test', { type: 'basic' })
...
//     const response = await request(app).get('/forgot-password?email=wrongEmail')
...
//     const response1 = await request(app).get('/forgot-password?email=test@hotmail.com')
