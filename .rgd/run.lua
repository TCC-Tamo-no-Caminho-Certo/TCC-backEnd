...
function runScript()
    ...
    elseif branch == "master" then
        ...
        runWD("pm2", "stop backend-dev", "/home/rgd/deploy/dist/backend")
        runWD("pm2", "start ./bundle.js --name backend-dev -- --config-/home/rgd/deploy/dist/.config/server.json", "/home/rgd/deploy/dist/backend")
    end
end
