...
const route = express
  ...
  .get('/api/validate-session', auth, async (req: Request, res: Response) => {
    try {
  ...
  .post('/api/sign-out', auth, async (req: Request, res: Response) => {
  ...
  .post('/api/sign-in', captcha, async (req: Request, res: Response) => {
  ...
  .post('/api/sign-up', captcha, async (req: Request, res: Response) => {
  ...
  .get('/confirm/sign-up/:token', async (req: Request, res: Response) => {
  ...
  .get('/confirm/email/:token', async (req: Request, res: Response) => {
    const { token } = req.params
  ...
  .get('/api/forgot-password/:email', async (req: Request, res: Response) => {
  ...
  .post('/api/reset-password/:token', captcha, async (req: Request, res: Response) => {
    const { token } = req.params
