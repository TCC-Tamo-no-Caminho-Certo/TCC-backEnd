                  ...
                  <tr>
                    ...
                    >
                      <p style="margin: 0">
                        ...
                        confirmar o endereço de email, para proseguir use o código
                        abaixo ou clique no botão.
                      </p>
                    </td>
                  </tr>
                  <tr>
                          ...
                          >
                            <table border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                >
                                  <a
                                    href="http://${config.environment === 'development' ? 'dev.' : null}steamslab.com/confirm/email/${token}"
                                    target="_blank"
                                    style="
                                      font-size: 20px;
                ...
                >
                  <tr>
                    ...
                    >
                      <br />
                      <p style="margin: 0">
                        Se você não pediu uma confirmação, por favor ignore este
